...
class SalesScreen extends StatelessWidget {
  ...
  Widget buildSalesItem(String range, String value) {
    return Container(
      width: double.infinity, // Make it stretch to max width
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontSize: 16,
              fontWeight:
                  FontWeight.bold, // Optional: makes the value stand out
            ),
          ),
        ],
      ),
  ...
  Widget buildMonthSection(String month, List<Map<String, String>> sales) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        ...sales.map((item) => buildSalesItem(item['range']!, item['value']!)),
